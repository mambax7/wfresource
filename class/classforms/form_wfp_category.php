...
if ($wfs) {
    $category_sid = new XoopsFormSelectSection(_AM_ECATEGORY_CSECTION, 'category_sid', $this->getVar('category_sid'), 1, false);
...
if ($wfs) {
    $category_type = new XoopsFormSelectType(_AM_ECATEGORY_TYPE, 'category_type', $this->getVar('category_type'));
...
$category_image = new XoopsFormSelectImage(_AM_ECATEGORY_SELECTIMAGE, 'category_image', $this->getVar('category_image'), 'xoops_image', 1);
...
$category_keywords = new XoopsFormTextArea(_AM_ECATEGORY_MKEYWORDS, 'category_keywords', $this->getVar('category_keywords', 'e'), $rows = 5, $cols = 50);
