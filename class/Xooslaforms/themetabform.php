...
require_once XOOPS_ROOT_PATH . '/modules/wfresource/class/xooslaforms/xoosla_form.php';
 ...
 * @access    public
 */
class XoopsThemeTabForm extends XooslaForm
{
    /**
...
//         $ret = '<div>' . $this->getTitle() . '</div>';
    ...
    public function startTab($tabText, $paneid)
    {
        ...
        $startTab = $this->_tabs->startTab($tabText, $paneid);
        $this->addElement($startTab);
    }
    ...
    public function endTab()
    {
        ...
        $endTab = $this->_tabs->endTab();
        $this->addElement($endTab);
    }
}
