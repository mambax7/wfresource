...
class XoopsFormSelectImage extends \XoopsFormSelect
{
     ...
     */
    public function __construct($caption, $name, $value, $id, $imgcat_id, $size = 5)
    {
     ...
     * @param $value
     */
    public function setCategory($value): array
    {
     ...
     * @param $value
     */
    public function setDir($value): int
    {
