...
//$mimeHandler = Utility::getHandler('mimetype');
$mimeHandler = Wfresource\Helper::getInstance()->getHandler('Mimetype');
...
$textarea = new Xoopsforms\XoopsFormTextArea(_AM_MIME_TYPEF, 'mime_types', $this->getVar('mime_types', 'e'), 15, 70);
$textarea->setDescription('<span style="font-size: x-small; font-weight: normal;">' . _AM_MIME_USEFULTAGS . '</span></span>');
$form->addElement($textarea, true);

$mimetype_image_dir = new Xoopsforms\XoopsFormSelectImage(_AM_MIME_EIMAGE, 'mime_images', $this->getVar('mime_images'), $id = 'xoops_image', 0);
$mimetype_image_dir->setDescription(_AM_MIME_EIMAGE_DSC);
$mimetype_image_dir->setCategory('/modules/wfresource/assets/images/mimetypes');
...
/*
        ...
        */
$mime_category = new Xoopsforms\XoopsFormSelect(_AM_MIME_ECATEGORY, 'mime_category', $this->getVar('mime_category'));
