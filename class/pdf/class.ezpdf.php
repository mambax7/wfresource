...
class Cezpdf extends Cpdf
{
    ...
    // ------------------------------------------------------------------------------
    public function ezPRVTaddPageNumbers()
    {
     ...
     * @param int $opt
     */
    public function ezPrvtTableDrawLines($pos, $gap, $x0, $x1, $y0, $y1, $y2, $col, $inner, $outer, $opt = 1)
    {
        $x0 = 1000;
        $x1 = 0;
    ...
    public function ezPrvtTableColumnHeadings(
        ...
        while ($ok == 0) {
            foreach ($cols as $colName => $colHeading) {
                ...
                $this->ezText($colHeading, $size, array(
                    'aleft'         => $pos[$colName],
     ...
     * @param array $options
     */
    public function execTemplate($id, array $data = null, array $options = null)
    {
