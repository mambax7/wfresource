<?php
// $Id: grouppermform.php 8181 2011-11-07 01:14:53Z beckmi $
// ------------------------------------------------------------------------ //
...
class XoopsGroupFormCheckBox extends XoopsFormElement
{
    ...
    public function _renderOptionTree(&$tree, $option, $prefix, array $parentIds = null)
    {
        ...
        $tree .= ' />' . $option['name'] . "<input type=\"hidden\" name=\"" . $ele_name . '[parents][' . $option['id'] . "]\" value=\"" . implode(':', $parentIds) . "\" /><input type=\"hidden\" name=\"" . $ele_name . '[itemname][' . $option['id']
                 . "]\" value=\"" . htmlspecialchars($option['name']) . "\" /><br>\n";
