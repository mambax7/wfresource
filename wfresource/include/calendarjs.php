...
if ( file_exists( $file = XOOPS_ROOT_PATH . '/modules/wfresource/language/' . $GLOBALS['xoopsConfig']['language'] . '/calendar.php' ) ) {
    include_once $file;
} else {
	include_once XOOPS_ROOT_PATH . '/modules/wfresource/language/english/calendar.php';
}
...
// date formats
Calendar._TT["DEF_DATE_FORMAT"] = "y-mm-dd h:s";
