...
class wfp_BrokenHandler extends wfp_ObjectHandler {
	...
	public function headingHtml( $value, $total_count ) {
		...
		$ret .= '<form><div style="text-align: left; margin-bottom: 12px;"><input type="button" name="button" onclick=\'location="admin.broken.php?op=edit"\' value="' . _MA_WFP_CREATENEW . '"></div></form>';
		$ret .= '<div>
