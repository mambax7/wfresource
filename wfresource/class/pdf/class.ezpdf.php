...
class Cezpdf extends Cpdf {
	...
	function ezColumnsStart( $options = array() ) {
		...
		$this->ez['columns']['margins'] = array( $this->ez['leftMargin'] , $this->ez['rightMargin'] , $this->ez['topMargin'] , $this->ez['bottomMargin']
			);
