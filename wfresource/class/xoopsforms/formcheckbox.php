...
class XoopsFormCheckBox extends XoopsFormElement {
	 ...
	 */
	function XoopsFormCheckBox( $caption, $name, $value = null, $delimeter = "&nbsp;", $show_button = false ) {
	...
	function render() {
		...
		if ( $this->_showbutton ) {
			$ret .= _MA_WFP_SELECTALL . '<input name="' . $ele_name . 'x_checkall" type="checkbox" onClick="this.value=xoopsCheckAllElementsButton(this,\'' . $this->getName() . '\')" value="' . _MA_WFP_SELECTALL . '">';
		}
		return $ret;
	}
