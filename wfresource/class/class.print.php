...
class wfp_doPrint {
     ...
     * @param array $opt
     */
    function wfp_doPrint( $opt = array() ) {
    ...
    function renderPrint() {
        ...
        $ret .= "<head>\n";
        $ret .= "<title>" . _MA_WFC_PRINTER . " - " . $this->options['title'] . " - " . $this->options['sitename'] . "</title>\n";
        ...
        $ret .= "<hr /></td>
					...
					<br />
				<div style='text-align: center;'><input type=button value='" . _MA_WFC_PRINT_PAGE . "' onclick='window.print();'></div><br />
				</body></html>\n";
        echo $ret;
    }
